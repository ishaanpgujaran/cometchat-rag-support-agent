...
- For TrailPlus members or orders with membership_tier 'trailplus', state their return window directly using the exact phrase '45 calendar days from delivery' (write '45 calendar days', not hyphenated '45-calendar-day', and without referencing standard 30-day non-member rules). For standard non-member orders, state '30 calendar days from delivery'.
